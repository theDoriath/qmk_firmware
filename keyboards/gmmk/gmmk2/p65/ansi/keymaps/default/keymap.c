...
[1] = LAYOUT(
  ...
  _______,  _______,  RGB_HUI,  RGB_HUD,  RGB_SPD,  RGB_SPI,  _______,  _______,  _______,  _______,  _______,  _______,             _______,
  _______,  _______,  LCTL(KC_Z) ,  LCTL(KC_X) ,  LCTL(KC_C) ,  LCTL(KC_V) ,  KC_MUTE,  KC_VOLU,  KC_VOLD,  KC_MPRV,  KC_MPLY,  KC_MNXT,  _______,   RGB_VAI,  KC_HOME,
